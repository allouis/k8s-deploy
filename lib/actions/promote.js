...
function promote(ignoreSslErrors) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (canaryDeploymentHelper.isSMICanaryStrategy()) {
            ...
            yield SMICanaryDeploymentHelper.redirectTrafficToCanaryDeployment(kubectl, TaskInputParameters.manifests);
            ...
            yield SMICanaryDeploymentHelper.redirectTrafficToStableDeployment(kubectl, TaskInputParameters.manifests);
        }
        else {
        ...
        try {
            yield canaryDeploymentHelper.deleteCanaryDeployment(kubectl, TaskInputParameters.manifests, includeServices);
        }
        catch (ex) {
